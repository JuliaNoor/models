...
if __name__ == '__main__':
  flags.DEFINE_string('input_video_label', '/Users/atislam//data/youtube_video/video_path_label.txt',
                    'TSV file with lines "<video_file_path>\t<start_time>\t<end_time>\t<class_label>" where '
                    ' and <labels> '
	            'must be an integer list joined with semi-colon ";"')
  flags.DEFINE_string( 'tfrecord_file', '/Users/atislam//data/youtube_video/feature_label.tfrecord',

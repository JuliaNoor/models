...
if __name__ == '__main__':
  flags.DEFINE_string('input_video_label', '/Users/julia/PSVA/data/output/game/game_video_path.txt',
                    'TSV file with lines "<video_file_path>\t<start_time>\t<end_time>\t<class_label>" where '
                    ' and <labels> '
	            'must be an integer list joined with semi-colon ";"')
  flags.DEFINE_string( 'tfrecord_file', '/Users/julia/PSVA/data/output/game/feature_label.tfrecord',

...
if __name__ == '__main__':
  flags.DEFINE_string('input_youtube_id_tsv', '/Users/julia/PSVA/data/output/balanced/youtube_balanced_train.txt',
                    'TSV file with lines "<id>\t<start_time>\t<end_time>\t<label>" where '
                    ' and <labels> '
	            'must be an integer list joined with semi-colon ";"')

  flags.DEFINE_string('output_dir','/Users/julia/PSVA/data/output/balanced', 'where to save the wav file')

...
#def extract_n_predict():
      
def main(unused_argv):
    print("Input file: " +FLAGS.input_wav_file)

        
    if (os.path.isfile(FLAGS.input_wav_file)): 
      examples_batch = vggish_input.wavfile_to_examples(FLAGS.input_wav_file)
 ...
 #  extract_n_predict()
       inference(video_batch_val ,num_frames_batch_val, FLAGS.checkpoint_file, FLAGS.train_dir, FLAGS.output_file)

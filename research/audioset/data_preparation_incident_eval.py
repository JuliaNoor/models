...
if __name__ == '__main__':
  flags.DEFINE_string('input', '/mnt/disks/disk-1/data/youtube_video/eval_segments.csv',
                    'CSV file with lines <id>,<start_time>,<end_time>,"<label>" where '
                    ' and <labels> ')
	            

  flags.DEFINE_string('output_dir','/mnt/disks/disk-1/data/youtube_video/incident', 'where to save the tsv file')

def main(unused_argv):
  print(FLAGS.input)


  f= open(FLAGS.output_dir+"/youtube_eval.txt","w+")
  print(FLAGS.output_dir+"/youtube_eval.txt")
